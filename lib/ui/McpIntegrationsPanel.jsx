					...
					>
						<div className="flex items-start gap-3">
							{isConnected ? (
								...
								<Clock className="w-5 h-5 text-zinc-600 shrink-0 mt-0.5" />
							)}
							<div className="flex-1 min-w-0">
								<p
									className={`text-sm font-semibold ${
										isConnected ? "text-emerald-900" : "text-zinc-900"
									}`}
								>
									{isConnected
								...
								<p
									className={`text-xs mt-1 leading-relaxed ${
										isConnected ? "text-emerald-800" : "text-zinc-800"
									}`}
								>
									{isConnected ? (
										<>
							...
							{revealedKey && (
								...
								>
									<div className="flex items-start gap-2">
										<AlertTriangle className="w-4 h-4 text-zinc-700 shrink-0 mt-0.5" />
									...
									<div className="flex flex-col sm:flex-row sm:items-center gap-2">
										<code className="flex-1 px-3 py-2 bg-white border border-zinc-200 rounded-xl text-xs font-mono break-all text-zinc-900">
											{revealedKey.apiKey}
										</code>
