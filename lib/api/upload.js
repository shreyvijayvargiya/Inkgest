...
import { uploadInlineImagesToUploadThing } from "../fileUpload";
...
export const uploadBlogImages = async (
	...
	try {
		...
		// Upload and replace content images (UploadThing on save, then Firebase for any remaining data URLs)
		if (updatedData.content) {
			updatedData.content = await uploadInlineImagesToUploadThing(
				updatedData.content
			);
