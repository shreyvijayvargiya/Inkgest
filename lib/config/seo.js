...
export const SEO_CONFIG = {
	// Homepage
	"/": {
		title: "Inkgest — URLs to newsletters, blogs & emails",
		description:
			"Turn any URL into a newsletter, blog, or email draft with AI. Scrape sources, edit with chat, export Markdown, HTML, or React.",
		keywords:
			"Inkgest, AI editor, newsletter, scrape URL, Markdown export, HTML export, React export, content workflow",
